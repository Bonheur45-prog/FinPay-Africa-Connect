          ...
          <article key={post.id} className={styles["related-card"]}>
            ...
            <div className={styles["related-card__body"]}>
              ...
              <Link
                ...
                className={styles["related-card__link"]}
              >
                Read More →
              </Link>
            </div>
  ...
  return (
    <article className={styles["blog-detail"]}>
        ...
        <div className={styles["blog-header__meta"]}>
          <div className={styles["author-info"]}>
            ...
            <div>
              ...
              <p className={styles["author-role"]}>{post.author.role}</p>
            </div>
          </div>
      ...
      <figure className={styles["featured-image"]}>
        <img src={post.image} alt={post.title[language]} className={styles["featured-image__img"]} />
      </figure>
